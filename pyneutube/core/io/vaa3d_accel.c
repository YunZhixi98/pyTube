...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "pyneutube.core.io.vaa3d_accel",
        "sources": [
            "pyneutube/core/io/vaa3d_accel.pyx"
        ]
    },
    "module_name": "pyneutube.core.io.vaa3d_accel"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pyneutube__core__io__vaa3d_accel
#define __PYX_HAVE_API__pyneutube__core__io__vaa3d_accel
/* Early includes */
#include <string.h>
#include <stdio.h>
...
#define __Pyx_PyUnicode_From_short(value, width, padding_char, format_char) (\
    ((format_char) == ('c')) ?\
        __Pyx_uchar___Pyx_PyUnicode_From_short(value, width, padding_char) :\
        __Pyx____Pyx_PyUnicode_From_short(value, width, padding_char, format_char)\
    )
static CYTHON_INLINE PyObject* __Pyx_uchar___Pyx_PyUnicode_From_short(short value, Py_ssize_t width, char padding_char);
static CYTHON_INLINE PyObject* __Pyx____Pyx_PyUnicode_From_short(short value, Py_ssize_t width, char padding_char, char format_char);
...
static void __pyx_f_9pyneutube_4core_2io_11vaa3d_accel__decompress_pbd16(uint8_t const *, Py_ssize_t, uint16_t *, Py_ssize_t, int); /*proto*/
...
#define __Pyx_MODULE_NAME "pyneutube.core.io.vaa3d_accel"
extern int __pyx_module_is_main_pyneutube__core__io__vaa3d_accel;
int __pyx_module_is_main_pyneutube__core__io__vaa3d_accel = 0;

/* Implementation of "pyneutube.core.io.vaa3d_accel" */
...
static CYTHON_INLINE int __pyx_f_9pyneutube_4core_2io_11vaa3d_accel__pbd_delta(unsigned int __pyx_v_encoded, unsigned int __pyx_v_threshold) {
  int __pyx_r;
  int __pyx_t_1;
...
static void __pyx_f_9pyneutube_4core_2io_11vaa3d_accel__decompress_pbd8(uint8_t const *__pyx_v_comp, Py_ssize_t __pyx_v_comp_len, uint8_t *__pyx_v_out, Py_ssize_t __pyx_v_out_len) {
  Py_ssize_t __pyx_v_cp;
  Py_ssize_t __pyx_v_dp;
  Py_ssize_t __pyx_v_count;
  Py_ssize_t __pyx_v_j;
  unsigned int __pyx_v_code;
  unsigned int __pyx_v_packed;
  unsigned int __pyx_v_delta_code;
  int __pyx_v_delta;
  int __pyx_v_prior;
  int __pyx_v_value;
...
static void __pyx_f_9pyneutube_4core_2io_11vaa3d_accel__decompress_pbd16(uint8_t const *__pyx_v_comp, Py_ssize_t __pyx_v_comp_len, uint16_t *__pyx_v_out, Py_ssize_t __pyx_v_out_len, int __pyx_v_little) {
  Py_ssize_t __pyx_v_cp;
  Py_ssize_t __pyx_v_dp;
  Py_ssize_t __pyx_v_count;
  Py_ssize_t __pyx_v_j;
  CYTHON_UNUSED Py_ssize_t __pyx_v_k;
  Py_ssize_t __pyx_v_bitpos;
...
/* Python wrapper */
static PyObject *__pyx_pw_9pyneutube_4core_2io_11vaa3d_accel_1load_v3draw(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyDoc_STRVAR(__pyx_doc_9pyneutube_4core_2io_11vaa3d_accel_load_v3draw, "load_v3draw(path)\n\nLoad a Vaa3D v3draw/raw file using direct NumPy file reads.");
static PyMethodDef __pyx_mdef_9pyneutube_4core_2io_11vaa3d_accel_1load_v3draw = {"load_v3draw", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9pyneutube_4core_2io_11vaa3d_accel_1load_v3draw, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_9pyneutube_4core_2io_11vaa3d_accel_load_v3draw};
static PyObject *__pyx_pw_9pyneutube_4core_2io_11vaa3d_accel_1load_v3draw(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("load_v3draw (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pyneutube_4core_2io_11vaa3d_accel_load_v3draw(__pyx_self, __pyx_v_path);
...
static PyObject *__pyx_pf_9pyneutube_4core_2io_11vaa3d_accel_load_v3draw(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_path) {
  PyObject *__pyx_v_header = 0;
  PyObject *__pyx_v_endian = 0;
  short __pyx_v_datatype;
  PyObject *__pyx_v_dims = 0;
  PyObject *__pyx_v_dtype = 0;
  PyObject *__pyx_v_native_dtype = 0;
  PyObject *__pyx_v_image = 0;
  PY_LONG_LONG __pyx_v_total_units;
  PY_LONG_LONG __pyx_v_expected_size;
...
*/
  ...
  #endif
  {
    PyObject *__pyx_callargs[3] = {__pyx_t_1, __pyx_t_3, __pyx_t_16};
...
*/
  ...
  __Pyx_XDECREF(__pyx_v_native_dtype);
...
/* Python wrapper */
static PyObject *__pyx_pw_9pyneutube_4core_2io_11vaa3d_accel_3load_v3dpbd(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyDoc_STRVAR(__pyx_doc_9pyneutube_4core_2io_11vaa3d_accel_2load_v3dpbd, "load_v3dpbd(path)\n\nLoad a Vaa3D PBD-compressed file with C-level decompression loops.");
static PyMethodDef __pyx_mdef_9pyneutube_4core_2io_11vaa3d_accel_3load_v3dpbd = {"load_v3dpbd", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9pyneutube_4core_2io_11vaa3d_accel_3load_v3dpbd, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_9pyneutube_4core_2io_11vaa3d_accel_2load_v3dpbd};
static PyObject *__pyx_pw_9pyneutube_4core_2io_11vaa3d_accel_3load_v3dpbd(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("load_v3dpbd (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pyneutube_4core_2io_11vaa3d_accel_2load_v3dpbd(__pyx_self, __pyx_v_path);
...
static PyObject *__pyx_pf_9pyneutube_4core_2io_11vaa3d_accel_2load_v3dpbd(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_path) {
  PyObject *__pyx_v_data = 0;
  uint8_t const *__pyx_v_comp;
  Py_ssize_t __pyx_v_comp_len;
  PyObject *__pyx_v_endian = 0;
  int __pyx_v_little;
  short __pyx_v_datatype;
  PyObject *__pyx_v_dims = 0;
  Py_ssize_t __pyx_v_total_units;
  PyArrayObject *__pyx_v_out8 = 0;
  PyArrayObject *__pyx_v_out16 = 0;
  PyObject *__pyx_v_handle = NULL;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_out16;
  __Pyx_Buffer __pyx_pybuffer_out16;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_out8;
  __Pyx_Buffer __pyx_pybuffer_out8;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("load_v3dpbd", 0);
  __Pyx_INCREF(__pyx_v_path);
  __pyx_pybuffer_out8.pybuffer.buf = NULL;
  __pyx_pybuffer_out8.refcount = 0;
  __pyx_pybuffernd_out8.data = NULL;
  __pyx_pybuffernd_out8.rcbuffer = &__pyx_pybuffer_out8;
  __pyx_pybuffer_out16.pybuffer.buf = NULL;
  __pyx_pybuffer_out16.refcount = 0;
...
*/
    ...
    if (!(likely(((__pyx_t_3) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_3, __pyx_mstate_global->__pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 534, __pyx_L1_error)
    {
      ...
      __pyx_t_19 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_out8.rcbuffer->pybuffer, (PyObject*)((PyArrayObject *)__pyx_t_3), &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_19 < 0)) {
        PyErr_Fetch(&__pyx_t_6, &__pyx_t_9, &__pyx_t_8);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_out8.rcbuffer->pybuffer, (PyObject*)__pyx_v_out8, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
...
*/
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_16 = ((PyObject *)__pyx_v_out8);
    __Pyx_INCREF(__pyx_t_16);
    if (unlikely(__pyx_v_dims == Py_None)) {
      PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
...
*/
    ...
    if (!(likely(((__pyx_t_3) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_3, __pyx_mstate_global->__pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 539, __pyx_L1_error)
    {
      ...
      __pyx_t_19 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_out16.rcbuffer->pybuffer, (PyObject*)((PyArrayObject *)__pyx_t_3), &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint16_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_19 < 0)) {
        PyErr_Fetch(&__pyx_t_8, &__pyx_t_9, &__pyx_t_6);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_out16.rcbuffer->pybuffer, (PyObject*)__pyx_v_out16, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint16_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
...
*/
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_18 = ((PyObject *)__pyx_v_out16);
...
*/
  ...
  __Pyx_XDECREF(__pyx_v_endian);
  __Pyx_XDECREF(__pyx_v_dims);
  __Pyx_XDECREF((PyObject *)__pyx_v_out8);
  __Pyx_XDECREF((PyObject *)__pyx_v_out16);
  __Pyx_XDECREF(__pyx_v_handle);
  __Pyx_XDECREF(__pyx_v_path);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static int __pyx_pymod_exec_vaa3d_accel(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_vaa3d_accel},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "vaa3d_accel",
      __pyx_k_Cython_accelerators_for_Vaa3D_im, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_vaa3d_accel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_vaa3d_accel(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_vaa3d_accel(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'vaa3d_accel' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "vaa3d_accel" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_vaa3d_accel", 0);
  ...
  if (__pyx_module_is_main_pyneutube__core__io__vaa3d_accel) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyneutube.core.io.vaa3d_accel")) {
      if (unlikely((PyDict_SetItemString(modules, "pyneutube.core.io.vaa3d_accel", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "pyneutube/core/io/vaa3d_accel.pyx":6
...
*/
  ...
  /* "pyneutube/core/io/vaa3d_accel.pyx":7
 * 
 * import os
 * import struct             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "pyneutube/core/io/vaa3d_accel.pyx":9
 * import struct
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init pyneutube.core.io.vaa3d_accel", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init pyneutube.core.io.vaa3d_accel");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
